...
namespace Microsoft.Azure.SpatialAnchors.Unity.Samples
{
    ...
    public class AzureSpatialAnchorsDemoWrapper : MonoBehaviour
    {
        ...
        /// </summary>
        public string SpatialAnchorsAccountId { get; private set;} = "38d420c0-949b-4df8-85d2-8063796af8d9";

        /// <summary>
        /// Set this string to the Spatial Anchors account key provided in the Spatial Anchors resource.
        /// </summary>
        public string SpatialAnchorsAccountKey { get; private set; } = "ncyueHZmVXbBf6JtJetM7igvEYEdTjk0HoS/J3FAtYk=";
